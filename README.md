...
Reopen the terminal and type git, if you get a response like the one below GIT has been installed correctly 
...
Screenshot both websites together, and add an explanation of what you changed between the deployed version and the development version, then explain why it could be beneifical to have both a development and deployment server.    
    </div>
</div>
